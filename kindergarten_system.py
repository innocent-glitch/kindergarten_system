...
# ==================== CREATE TEMPLATES BEFORE ROUTES ====================
...
<head>
    ...
    <style>
        ...
        .btn-outline-primary:hover { background: var(--gradient); color: white; border-color: transparent; }
        .btn-outline-success { border-color: #87CEEB; color: #87CEEB; }
        .btn-outline-success:hover { background: var(--gradient); color: white; border-color: transparent; }
    </style>
</head>
<body>
...
# Create templates immediately when the app starts
create_templates()
